...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_32 | unet_256 | unet_128]')
        ...
        # dataset parameters
        parser.add_argument('--data_dim', type=int, default=2, help='dimension of the data: 2|3')
    ...
    def gather_options(self, args=None):
        ...
        # manually retrive args to enable easy testing
        if args == None:
            args = sys.argv[1:]
        ...
        # get the basic options with the args argument
        ...
        # parse again with new defaults with the args argument
        opt, _ = parser.parse_known_args(args)
        ...
        # save and return the parser with the args argument
        self.parser = parser
